...
| R2 full penalty | 0.9786 | [0.9702, 0.9843] | 9.88e-323 |

Paired difference, `ρ(R2) - ρ(R0)`: **0.0314**, with a paired state
bootstrap 95% CI of **[0.0222, 0.0428]**.

This result **supports** the proposed middle link. A positive,
